...
Enable Google Search Tool:
  description: Enables the model to [query Google Search](https://ai.google.dev/gemini-api/docs/grounding), this may cause the model to lookup on the web information you may want to retrieve from your home. If this happens you can try editing the Instructions to instruct it not to. 
{% endconfiguration_basic %}
